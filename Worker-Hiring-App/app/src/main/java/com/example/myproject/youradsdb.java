...
public class youradsdb extends FirebaseRecyclerAdapter<MainModel, youradsdb.myViewHolder> {
/**
 ...
 * @param options
 */
public youradsdb(@NonNull FirebaseRecyclerOptions<MainModel> options) {
        super(options);
        }
